...
import (
	...
	"github.com/mhson281/grafanaOperator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "862d93b9.tcodelab.com",
	...
	if err = (&controller.GrafanaTeamReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "GrafanaTeam")
		os.Exit(1)
	}
